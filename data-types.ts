...
const shopingListMen = ["boxers", "singlets", "data", "ties", "pants", "shoes", "mummy's shoes"];
const shopingListLadies = ["bags", "ear rings", "prefume", "make-up box"];

// how do we access items in an array?
console.log("--------------Accessing Array-------------");
console.log(shopingListMen)


// length of array
console.log (shoopingListLadies.length);
console.log (shoopingListMen.length);
...
const unique_items = new Set ([4,4,6,8,2,2,2])
...
const contact_details = { 
 ...
 console.log(contact_details.email);
